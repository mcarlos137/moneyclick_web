...
import '../FastChangePrice/FastChangePrice.css';
...
class NewFastChangePrice extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default translate(NewFastChangePrice);
